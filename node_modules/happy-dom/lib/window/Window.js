...
const Audio_1 = __importDefault(require("../nodes/html-audio-element/Audio"));
...
const MessageEvent_1 = __importDefault(require("../event/events/MessageEvent"));
...
const MessagePort_1 = __importDefault(require("../event/MessagePort"));
...
class Window extends EventTarget_1.default {
    ...
    constructor(options) {
        ...
        this.HTMLIFrameElement = HTMLIFrameElement_1.default;
        ...
        this.SVGGraphicsElement = SVGGraphicsElement_1.default;
        ...
        this.MessageEvent = MessageEvent_1.default;
        ...
        this.MessagePort = MessagePort_1.default;
        ...
        class Audio extends Audio_1.default {
        }
    ...
    postMessage(message, targetOrigin = '*', _transfer) {
        ...
        if (targetOrigin && targetOrigin !== '*' && this.location.origin !== targetOrigin) {
            throw new DOMException_1.default(`Failed to execute 'postMessage' on 'Window': The target origin provided ('${targetOrigin}') does not match the recipient window\'s origin ('${this.location.origin}').`, DOMExceptionNameEnum_1.default.securityError);
        }
        try {
            JSON.stringify(message);
        }
        catch (error) {
            throw new DOMException_1.default(`Failed to execute 'postMessage' on 'Window': The provided message cannot be serialized.`, DOMExceptionNameEnum_1.default.invalidStateError);
        }
        this.dispatchEvent(new MessageEvent_1.default('message', {
            data: message,
