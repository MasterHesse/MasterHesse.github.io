...
var transformer = () => (from, fn) => (payload) => (0, import_function.pipe)(
  payload,
  (0, import_TaskEither.map)(
    (p2) => (0, import_TaskEither.tryCatch)(
      ...
      (e) => {
        return `Problem encountered during the "${p2.stage}" stage of the vite-plugin-md transform pipeline:
...
var lift = (payload) => () => Promise.resolve(E.right(payload));
...
var applyMarkdownItOptions = () => transformer()("parser", (payload) => {
...
var baseStyling = () => transformer()("metaExtracted", (p2) => {
  var _a2;
...
var kebabCaseComponents = () => transformer()(
  "parsed",
  (p2) => {
...
var createParser = () => transformer()("metaExtracted", (payload) => {
  var _a2;
...
var convertToDom = () => transformer()("parsed", (payload) => {
...
var import_gray_matter = require("@yankeeinlondon/gray-matter");

// src/pipeline/pipelineUtilityFunctions.ts
...
var extractFrontmatter = () => transformer()(
  "initialize",
  (p2) => {
    var _a2, _b;
    if (!p2.options.frontmatter) {
      return __spreadValues(__spreadProps(__spreadValues({}, p2), {
        stage: "metaExtracted",
        frontmatter: {},
        md: p2.content,
        meta: [],
    ...
    const r = (0, import_gray_matter.matter)(p2.content || "", go);
    ...
    return __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, p2), {
      stage: "metaExtracted"
    }), pipelineUtilityFunctions(p2)), {
...
var frontmatterPreprocess = () => transformer()("metaExtracted", (payload) => {
  var _a2, _b;
...
var loadMarkdownItPlugins = () => transformer()("parser", (payload) => {
...
var parseHtml = () => transformer()("parser", (payload) => {
  try {
...
var repairFrontmatterLinks = () => transformer()(
  "parsed",
  (payload) => {
...
var transformsBefore = () => transformer()(
  "initialize",
  (p2) => {
